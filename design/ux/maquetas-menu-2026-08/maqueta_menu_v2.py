...
carta((W - 236, y_top, W - 16, y_top + 38), 19)               # presupuesto
...
# presupuesto
d.ellipse([W - 222, y_top + 10, W - 204, y_top + 28], fill=(226, 244, 234))
texto(d, (W - 218, y_top + 9), "€", SEMI, 14, VERDE)
texto(d, (W - 194, y_top + 8), "3.000 €", SEMI, 16, TINTA, 160)
...
dl.text((16, 12), "MAQUETA v2 · MODERNO — el lenguaje de Two Point / Sims 4: claro, blanco, sombras suaves, un acento",
        font=F(BOLD, 18), fill=(240, 240, 240))
lienzo.paste(img.convert("RGB"), (0, 46))
lienzo.save(os.path.join(SCRATCH, "menu_v2_moderno.png"))
print("OK")
